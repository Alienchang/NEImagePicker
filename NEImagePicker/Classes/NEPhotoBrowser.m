//
//  NEPhotoBrowserViewController.m
//  ImagePicker
//
...
- (void)updateSelestedNumber {
    ...
    [self.sendButton setEnabled:self.sendButton.badgeValue.integerValue != 0];
}
...
- (UICollectionView *)browserCollectionView {
    if (nil == _browserCollectionView) {
        ...
        [_browserCollectionView registerClass:[NEBrowserCell class] forCellWithReuseIdentifier:NSStringFromClass([NEBrowserCell class])];
